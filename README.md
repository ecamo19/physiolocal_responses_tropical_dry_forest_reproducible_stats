...
To reproduce the result click on the binder bottom. This will take you to a binder repository where the code can be run. The image __takes approximately __10-20 minutes__ to build.
